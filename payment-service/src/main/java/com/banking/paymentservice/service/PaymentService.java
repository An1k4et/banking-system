...
public class PaymentService {
     ...
     *  2. Save order details to frontend
     *  3. Return order details to frontend
     *  4. Frontend share Razorpay Checkout
     *  5. User pays
    ...
    */
    public PaymentOrderResponse createPaymentOrder(CreatePaymentRequest request) throws RazorpayException {
    	...
    	int amountToPaisa = request.getAmount().multiply(BigDecimal.valueOf(100)).intValue();
    	
    	JSONObject orderRequest = new JSONObject();
    	orderRequest.put("amount", amountToPaisa);
